...
const columns: ColumnsType<TransactionRecord> = [
  ...
  { title: 'Số tiền', dataIndex: 'amount', align: 'right', render: (value: number) => `${Number(value).toLocaleString('vi-VN')} ₫` },
  { title: 'Phí', dataIndex: 'fee', align: 'right', render: (value: number) => `${Number(value).toLocaleString('vi-VN')} ₫` },
];
