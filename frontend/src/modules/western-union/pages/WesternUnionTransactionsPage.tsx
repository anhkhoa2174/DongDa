    ...
    <div className="mt-2 mb-4 rounded-lg border border-teal-200 bg-teal-50 p-5">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="border-teal-200 text-center lg:border-x">
          ...
          <div className="mt-1 text-xs text-slate-500">({impliedRate.toLocaleString('vi-VN')} - {appliedRate.toLocaleString('vi-VN')}) x {formatUsd(paidUsd)}</div>
        </div>
        <div className="text-center">
...
const columns: ColumnsType<TransactionRecord> = [
  ...
  { title: 'Applied', dataIndex: 'appliedPaidRate', align: 'right', render: (value: number) => Number(value ?? 0).toLocaleString('vi-VN') },
  {
    title: 'Profit',
    key: 'profit',
    align: 'right',
