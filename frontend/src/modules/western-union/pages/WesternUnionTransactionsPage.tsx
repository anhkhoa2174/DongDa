...
const fields: TransactionField[] = [
  ...
  { name: 'paidUsd', label: 'Amount USD', kind: 'number', required: true, positive: true, span: 8, precision: 2, suffix: 'USD' },
  { name: 'paidVnd', label: 'Amount VND', kind: 'number', required: true, positive: true, span: 8, suffix: 'VND' },
  { name: 'wuRate', label: 'WU Implied Rate (auto)', kind: 'number', span: 8, readOnly: true, precision: 4 },
  { name: 'receivedUsd', label: 'Receive USD chẵn', kind: 'number', required: true, span: 8, precision: 0, suffix: 'USD' },
  { name: 'receivedVnd', label: 'Receive VND phần lẻ', kind: 'number', required: true, span: 8, suffix: 'VND' },
  {
